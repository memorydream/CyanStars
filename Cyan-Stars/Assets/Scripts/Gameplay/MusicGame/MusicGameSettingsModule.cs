...
namespace CyanStars.Gameplay.MusicGame
{
    public class MusicGameSettingsModule : BaseDataModule
    {
        private static class EvaluateRanges
        {
            ...
            {
                Normal = new EvaluateRange(0.080f, 0.140f, 0.140f, -0.230f);
                Hard = new EvaluateRange(0.040f, 0.100f, 0.120f, -0.160f);
                Easy = new EvaluateRange(0.120f, 0.180f, 0.180f, -0.230f);
            }
        }
